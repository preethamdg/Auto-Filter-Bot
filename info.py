...
# Bot information
API_ID = environ.get('API_ID', '23009724')
if len(API_ID) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '2089142494')
if len(ADMINS) == 0:
...
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002470010762')
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', 'https://t.me/preethamdg0')
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://sanjanadgpreethamdg:Sanju@cluster0.06nox.mongodb.net/")
if len(DATABASE_URL) == 0:
    print('Error - DATABASE_URL is missing, exiting now')
    exit()
DATABASE_NAME = environ.get('DATABASE_NAME', "sanjanadgpreethamdg")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Files store')

# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://t.me/preethamdg0')
OWNER_USERNAME = environ.get("OWNER_USERNAME", "https://t.me/+j2Qc6RmfBA8wZTI1")
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/+FOxMauI5h880ODA1')
FILMS_LINK = environ.get('FILMS_LINK', 'https://t.me/+FOxMauI5h880ODA1')
TUTORIAL = environ.get("TUTORIAL", "https://t.me/+FOxMauI5h880ODA1")
